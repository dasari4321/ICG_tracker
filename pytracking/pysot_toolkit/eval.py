...
#parser.add_argument('--trackers', '-t', nargs='+', help='tracker name')
...
def main():
    trackers = ['STM']#args.trackers#['ATOM',  'ECO', 'MDNet', 'Ours',  'SiamRCNN',  'SiamRPNpp', 'STM', 'TransT'] #
...
#                            '../testing_dataset'))
    root = '/media/hd2/mohana/Operation_RedGiant/ALTO/DATASETS/'
...
#            if k=='Occlusion':
            draw_success_precision(success_ret,'OTB2015',v,str(k), precision_ret, bold_name='Ours')
#####################################################################
...
#####################################################################
 #       for k, v in dataset.attr.items():
#            if k=='Occlusion':
  #          draw_success_precision(success_ret,'LaSOT',v,str(k), precision_ret, bold_name='Ours')
#####################################################################
...
#        for k, v in dataset.attr.items():
#            if k=='Full Occlusion':
#            draw_success_precision(success_ret,'UAV123',v,str(k), precision_ret, bold_name='Ours')
#####################################################################
