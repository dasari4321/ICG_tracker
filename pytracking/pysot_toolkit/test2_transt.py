...
def main(mode='IR', visulization=False):
    ...
    # setup tracker
    net_path = '/home/dasari/TransT/checkpoints/ltr/transt/transt_uav/transt.pth.tar' #'./ep600.pth.tar'
    ...
    # setup experiments
    video_paths = sorted(glob.glob(os.path.join('/home/dasari/datasets/Anti-UAV-RGBT','test-dev', '*')))
