...
# -*- coding: utf-8 -*-
"""
Created on Mon May 23 17:34:10 2022
...
from pytracking.tracker.KCF.kcftracker import KCFTracker as KCF
...
parser.add_argument('--name', default='kcf', type=str,
        ...
        for v_idx, video in enumerate(dataset):
            ...
            for idx, (img, gt_bbox) in enumerate(video):
                ...
                if idx == frame_counter:
                    ...
                    bb = np.array(init_info["init_bbox"],dtype=np.float32)
                    tracker = tracker.init(bb, img)
                    pred_bbox = gt_bbox_
...
#                    pred_bbox = gt_bbox
            ...
            print('({:3d}) Video: {:12s} Time: {:4.1f}s Speed: {:3.1f}fps Lost: {:d} mIOU:{:3.2f}'.format(
                    v_idx+1, video.name, toc, idx / toc, lost_number,  np.array(overlap).mean()))
