...
def parameters():
    ...
    shallow_params.compressed_dim = 96       # Dimension output of projection matrix for shallow features
    deep_params.compressed_dim = 96          # Dimension output of projection matrix for deep features
    #############
    ##############
