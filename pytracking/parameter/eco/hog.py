...
def parameters():
    ...
    shallow_params.compressed_dim = 4       # Dimension output of projection matrix for shallow features
    deep_params.compressed_dim = 4          # Dimension output of projection matrix for deep features
...
#                                pool_stride=[2, 1], normalize_power=2)
    features = deep.ResNet18m1(output_layers=['ft'], use_gpu=params.use_gpu, fparams=fparams,
