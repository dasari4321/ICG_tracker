...
def main():
    ...
    parser.add_argument('--tracker_name', default='eco', help='Name of tracking method.')
    parser.add_argument('--tracker_param', default='edg', help='Name of parameter file.')
    parser.add_argument('--runid', type=int, default=11, help='The run id.')
    parser.add_argument('--dataset_name', type=str, default='otb', help='Name of dataset (otb, nfs, uav, tpl, vot, tn, gott, gotv, lasot).')
    parser.add_argument('--sequence', type=str, default='Tiger1', help='Sequence number or name.')
